...
for (const solution of equationResult.solutions) {
  // Topic 11: BigInt (Modified to avoid non-integer conversion)
...
const obj1 = new CustomObject('2x^2 + 3x - 5 = 0');
weakSet.add(obj1);
...
weakMap.set(obj1, equationResult.solutions);
console.log(`WeakMap has solutions: ${weakMap.get(obj1)}`);
